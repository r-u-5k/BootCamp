...
public class StudentDaoDynamicSql {
	...
	public List<Student> findStudents(Student findStudent) {
		...
		List<Student> studentList = sqlSession.selectList(NAMESPACE + "findStudents", findStudent);
		sqlSession.close();
		return studentList;
	}
	...
	public List<Student> findStudentsOrder(String columnName) {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		List<Student> studentList = sqlSession.selectList(NAMESPACE + "findStudentsOrder", columnName);
		sqlSession.close();
		return studentList;
	}
