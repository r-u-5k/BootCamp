...
public interface GuestMapper {
	...
	@Insert("insert into guest values(#{guestNo},#{guestName},sysdate,"
	...
	@Update("update guest set guest_name=#{guestName},guest_email=#{guestEmail},"
			+ "guest_homepage=#{guestHomepage},guest_title=#{guestTitle},guest_content=#{guestContent} where guest_no=#{guestNo}")
