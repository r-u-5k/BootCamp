...
public class GuestController {
	 ...
	 */
	@GetMapping(value = "/guest_view", params = "guest_no")
	public String guest_view(@RequestParam(name = "guest_no", required = false, defaultValue = "321") int guest_no,
			Model model) {
		String forwardPath = "";
		try {
	...
	public String guest_write_action(@RequestParam(name = "guest_name") String guest_name,
			...
			@RequestParam(name = "guest_content") String guest_content, RedirectAttributes redirectAttributes) {
		try {
			int guest_no = guestService.guestWrite(
	...
	public String guest_modify_action(@RequestParam(name = "guest_no") int guest_no,
