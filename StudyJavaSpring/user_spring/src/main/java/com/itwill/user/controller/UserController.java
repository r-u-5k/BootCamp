...
public class UserController {
	...
	//@MyAnnotation(value = "http://www.naver.com", age = 25, name = "JIN", basePackages = { "com.itwill", "com.itwell" })
	...
	*/
	// RedirectAttributes에 fuser를 담아 redirect. 그래야 url이 action에서 form으로 바뀜
	@PostMapping("/user_write_action")
